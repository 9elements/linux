...
static int vfio_pci_igd_dsm_mmap(struct vfio_pci_core_device *vdev,
				 struct vfio_pci_region *region,
...
static ssize_t vfio_pci_igd_dsm_rw(struct vfio_pci_core_device *vdev, char __user *buf,
...
static void vfio_pci_igd_dsm_release(struct vfio_pci_core_device *vdev,
				     struct vfio_pci_region *region)
{
}
...
static int vfio_pci_igd_dsm_init(struct vfio_pci_core_device *vdev)
{
	u16 gmch;
	u32 dsm_size;
	u64 dsm_base;
